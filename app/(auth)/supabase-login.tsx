...
export default function SupabaseLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Show migration screen to handle data migration
  ...
  const handleMigrationComplete = async () => {
    try {
      // Fetch user profile after migration
  ...
  const handleMigrationSkip = async () => {
    try {
      // Just fetch the profile without migration
  ...
  if (showMigration) {
    return <SupabaseMigration onComplete={handleMigrationComplete} onSkip={handleMigrationSkip} />;
  }
